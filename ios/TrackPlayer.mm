// Modified by EvoPixel for main-queue dispatch and typed codegen constants
...
- (nonnull facebook::react::ModuleConstants<JS::NativeTrackPlayer::Constants::Builder>)constantsToExport {
  // RN macOS 0.81 codegen tags this same NSDictionary with Builder instead of Constants.
  return (facebook::react::ModuleConstants<JS::NativeTrackPlayer::Constants::Builder>)
      facebook::react::typedConstants<JS::NativeTrackPlayer::Constants>({
      .CAPABILITY_PLAY = 1,
      ...
      .REPEAT_TRACK = 1,
      .REPEAT_QUEUE = 2,
      .PITCH_ALGORITHM_LINEAR = 1,
      .PITCH_ALGORITHM_MUSIC = 2,
      .PITCH_ALGORITHM_VOICE = 3,
  });
}
