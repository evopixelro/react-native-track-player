// TrackPlayer.swift
// Modified by EvoPixel for capability mapping, queue completion and event dispatch
import Foundation
import MediaPlayer
import SwiftAudioEx
import React
...
public class NativeTrackPlayerImpl: NSObject, AudioSessionControllerDelegate {
    ...
    public func update(options: [String: Any], resolve: RCTPromiseResolveBlock, reject: RCTPromiseRejectBlock) {
        ...
        let capabilityNames: [Int: String] = [
            1: "play", 4: "pause", 5: "stop", 6: "seek",
            8: "next", 9: "previous", 10: "jumpForward", 11: "jumpBackward"
        ]
        var capabilitiesStr = (options["capabilities"] as? [Int] ?? []).compactMap { capabilityNames[$0] }
