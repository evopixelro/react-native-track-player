//
//  Track.swift
//  Modified by EvoPixel to map numeric pitch algorithms
//  RNTrackPlayer
//
...
class Track: AudioItem, TimePitching, AssetOptionsProviding {
    ...
    init?(dictionary: [String: Any]) {
        ...
        let pitchAlgorithms = [1: "linear", 2: "music", 3: "voice"]
        self.pitchAlgorithm = (dictionary["pitchAlgorithm"] as? Int).flatMap { pitchAlgorithms[$0] }
