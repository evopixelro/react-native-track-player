    ...
    [
      ...
      ({
        docs: {
          lastVersion: 'current',
          versions: {
            current: {label: '5.0.4', path: ''},
          },
          sidebarPath: require.resolve('./sidebars.js'),
          editUrl: 'https://github.com/evopixelro/react-native-track-player/tree/main/docs/',
        },
        theme: {
    ...
    ({
      navbar: {
        ...
        items: [
          ...
          {
            href: 'https://github.com/evopixelro/react-native-track-player',
            position: 'right',
