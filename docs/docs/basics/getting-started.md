...
const track3 = {
    url: 'file:///storage/sdcard0/Downloads/ice-age.mp3', // Load media from the file system
    title: 'Ice Age',
    artist: 'deadmau5',
...
import TrackPlayer, { State } from '@evopixel/react-native-track-player';
...
import { Event, useTrackPlayerEvents } from '@evopixel/react-native-track-player';
...
```tsx
import TrackPlayer, { useProgress } from '@evopixel/react-native-track-player';
...
```ts
import TrackPlayer, { Capability } from '@evopixel/react-native-track-player';
